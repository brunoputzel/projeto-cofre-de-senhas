                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('credentials.store') }}">
                        @csrf <div>
                            ...
                            <input id="service_name" class="block mt-1 w-full" type="text" name="service_name" value="{{ old('service_name') }}" required autofocus />
                            @error('service_name')
                        ...
                        <div class="mt-4">
                            ...
                            <div class="relative">
                                <input id="password" class="block mt-1 w-full pe-10" type="password" name="password" required />
